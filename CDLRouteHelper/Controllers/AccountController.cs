...
namespace CDLRouteHelper.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult DoesUsernameExist(string username)
        {
            ...
            return Json(new { IsExisting = result });
        }
        ...
        public ActionResult Login(LoginModel model, string returnUrl)
        {
            ...
            {
                var userId = WebSecurity.GetUserId(model.UserName);  // get UerId
                UserData.InitializeCurrentUserById(userId);          //get User info -- in framework
        ...
        public ActionResult ExternalLoginConfirmation(RegisterExternalLoginModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                using(CDLRouteHelper.Data.CDLContext db = new Data.CDLContext())
                {
